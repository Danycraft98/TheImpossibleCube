...
from settings import prepare, status_machine, menu_functions
from entity import enemy_entity
from world import sidebar, world
...
class Game(status_machine.State):
    ...
    def save_player(self):
        """
        Retrieve needed settings and save it in the player's save slot using YAML.
        """
        ...
        try:
            ...
            print("Problem loading settings. Exiting.")
            raise
...
class PlayAgain(menu_functions.BasicMenu):
    """A class for the simple menu that runs on game over."""

    def __init__(self, center):
        menu_functions.BasicMenu.__init__(self, 2)
...
class RetrySkeleton(enemy_entity.Skeleton):
    """A class for the skeletons that animate on game over."""

    def __init__(self, pos):
        enemy_entity.Skeleton.__init__(self, pos, 0)

...
from settings import prepare, tools, menu_functions
...
class Register(menu_functions.BidirectionalMenu):
    """
    ...
    def startup(self, now, persistant):
        ...
        """
        menu_functions.BidirectionalMenu.startup(self, now, persistant)
    ...
    def save_new(self):
        """
        Save newly created player to the save settings file.
